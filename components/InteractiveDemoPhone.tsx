...
const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    subtitle: "7 Independent Statutory Routes",
    badge: "No Shared Pool",
    icon: Layers,
    color: "from-purple-500 to-indigo-400",
    statute: "Rule 64-4.224 Non-Smokable Caps",
    headline: "Vaping Does NOT Burn Your Flower Limit",
    description: "Each of Florida's 6 non-smokable routes has its own independent 70-day window: Inhalation (24,500 mg), Oral (14,000 mg), Edibles (4,200 mg), Topical (10,500 mg), Sublingual (13,300 mg), and Suppository (13,650 mg). Dispensing heavily on one route never lowers another.",
    whereToLook: "Look at the Inhalation meter: even with 18,200 mg used, your Smokable Flower and Edible bars remain completely unaffected.",
  },
  {
    id: 4,
